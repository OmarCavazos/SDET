function gradeProcessor(grades) {
    for (let index in grades) {
        grades[index] =
            (grades[index] >= 90 && grades[index] <= 100) ? "A" :
            (grades[index] >= 80 && grades[index] < 90) ? "B" :
            (grades[index] >= 70 && grades[index] < 80) ? "C" :
            (grades[index] >= 60 && grades[index] < 70) ? "D" :
            (grades[index] < 60 && grades[index] > 0) ? "F" : "error";
